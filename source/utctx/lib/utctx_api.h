...
typedef enum _UtopiaValue
{
    ...
    UtopiaValue_WAN_Max_MRU,
    UtopiaValue_WAN_PPPIPCPEnable,
    UtopiaValue_WAN_PPPIPV6CPEnable,
    ...
    UtopiaValue_VLANTerminationCount,
    UtopiaValue_VLANTermination,
    UtopiaValue_VLANTermination_InsNum,
    UtopiaValue_VLANTermination_Alias,
    UtopiaValue_VLANTermination_LowerLayer,
    UtopiaValue_VLANTermination_Name,
    UtopiaValue_VLANTermination_TPID,
    UtopiaValue_VLANTermination_VLANID,
    UtopiaValue_VLANTermination_Enable,
    UtopiaValue_VLANTermination_EthLinkName,
