...
#ifdef HDK_LOGGING
static HDK_LOG_CallbackData s_HDK_XML_LoggingCallbackData =
{
    0 /* pfn */,
    0 /* pCtx */
};
...
{
#ifdef HDK_LOGGING
    return &s_HDK_XML_LoggingCallbackData;
...
{
#ifdef HDK_LOGGING
    s_HDK_XML_LoggingCallbackData.pfn = pfnCallback;
    s_HDK_XML_LoggingCallbackData.pCtx = pCtx;
#else /* ndef HDK_LOGGING */
    (void)pfnCallback;
    (void)pCtx;
#endif /* def HDK_LOGGING */
