...
namespace HDK
{
    ...
    namespace Cisco
    {
        ...
        typedef HDK::StructArray<CiscoCSVableStructStruct, ACTUAL_CLIENT_DOM_MOD_Element_Cisco_CiscoCSVableStruct> CiscoCSVableStructArray;
        typedef HDK::StructArray<CiscoCSVableStructStruct, ACTUAL_CLIENT_DOM_MOD_Element_Cisco_CiscoCSVableStruct>::StructArrayIter CiscoCSVableStructArrayIter;
