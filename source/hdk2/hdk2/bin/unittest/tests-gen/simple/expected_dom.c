...
static const HDK_XML_ElementNode s_elements[] =
{
    ...
    /* ACTUAL_DOM_Element_Cisco_CiscoCSVableStruct = 3 */ { 0, "CiscoCSVableStruct" },
    /* ACTUAL_DOM_Element_Cisco_CiscoStruct = 4 */ { 0, "CiscoStruct" },
    /* ACTUAL_DOM_Element_Cisco_a = 5 */ { 0, "a" },
    /* ACTUAL_DOM_Element_Cisco_as = 6 */ { 0, "as" },
    /* ACTUAL_DOM_Element_Cisco_b = 7 */ { 0, "b" },
    /* ACTUAL_DOM_Element_Cisco_bs = 8 */ { 0, "bs" },
    /* ACTUAL_DOM_Element_Cisco_c = 9 */ { 0, "c" },
    /* ACTUAL_DOM_Element_Cisco_cs = 10 */ { 0, "cs" },
    /* ACTUAL_DOM_Element_Cisco_csvInts = 11 */ { 0, "csvInts" },
    /* ACTUAL_DOM_Element_Cisco_csvStruct = 12 */ { 0, "csvStruct" },
    /* ACTUAL_DOM_Element_Cisco_csvStructs = 13 */ { 0, "csvStructs" },
    /* ACTUAL_DOM_Element_Cisco_int = 14 */ { 0, "int" },
    /* ACTUAL_DOM_Element_Cisco_string = 15 */ { 0, "string" },
    /* ACTUAL_DOM_Element_Cisco_A_CiscoAction = 16 */ { 1, "CiscoAction" },
    /* ACTUAL_DOM_Element_Cisco_A_CiscoActionResponse = 17 */ { 1, "CiscoActionResponse" },
    /* ACTUAL_DOM_Element_Cisco_A_CiscoActionResult = 18 */ { 1, "CiscoActionResult" },
    /* ACTUAL_DOM_Element_Cisco_A_CiscoStruct = 19 */ { 1, "CiscoStruct" },
    /* ACTUAL_DOM_Element_Cisco_A_a = 20 */ { 1, "a" },
    /* ACTUAL_DOM_Element_Cisco_A_as = 21 */ { 1, "as" },
    /* ACTUAL_DOM_Element_Cisco_A_b = 22 */ { 1, "b" },
    /* ACTUAL_DOM_Element_Cisco_A_bs = 23 */ { 1, "bs" },
    /* ACTUAL_DOM_Element_Cisco_A_c = 24 */ { 1, "c" },
    /* ACTUAL_DOM_Element_Cisco_A_cs = 25 */ { 1, "cs" },
    /* ACTUAL_DOM_Element_Cisco_A_int = 26 */ { 1, "int" },
    /* ACTUAL_DOM_Element_Cisco_A_string = 27 */ { 1, "string" },
    /* ACTUAL_DOM_Element_Schemas_xmlsoap_org_soap_envelope_Body = 28 */ { 2, "Body" },
    /* ACTUAL_DOM_Element_Schemas_xmlsoap_org_soap_envelope_Envelope = 29 */ { 2, "Envelope" },
    /* ACTUAL_DOM_Element_Schemas_xmlsoap_org_soap_envelope_Header = 30 */ { 2, "Header" },
...
static const HDK_XML_SchemaNode s_schemaNodes_Cisco_CiscoAction_Input[] =
{
    ...
    /* 5 */ { 3, ACTUAL_DOM_Element_Cisco_csvInts, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_CSV },
    /* 6 */ { 3, ACTUAL_DOM_Element_Cisco_csvStruct, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_CSV },
    /* 7 */ { 3, ACTUAL_DOM_Element_Cisco_csvStructs, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_CSV },
    /* 8 */ { 4, ACTUAL_DOM_Element_Cisco_a, HDK_XML_BuiltinType_Int, 0 },
    /* 9 */ { 4, ACTUAL_DOM_Element_Cisco_as, HDK_XML_BuiltinType_Struct, 0 },
    /* 10 */ { 4, ACTUAL_DOM_Element_Cisco_b, HDK_XML_BuiltinType_String, 0 },
    /* 11 */ { 4, ACTUAL_DOM_Element_Cisco_bs, HDK_XML_BuiltinType_Struct, 0 },
    /* 12 */ { 4, ACTUAL_DOM_Element_Cisco_c, ACTUAL_DOM_EnumType_Cisco_CiscoEnum, 0 },
    /* 13 */ { 4, ACTUAL_DOM_Element_Cisco_cs, HDK_XML_BuiltinType_Struct, 0 },
    /* 14 */ { 5, ACTUAL_DOM_Element_Cisco_int, HDK_XML_BuiltinType_Int, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 15 */ { 6, ACTUAL_DOM_Element_Cisco_a, HDK_XML_BuiltinType_Int, 0 },
    /* 16 */ { 6, ACTUAL_DOM_Element_Cisco_b, HDK_XML_BuiltinType_String, 0 },
    /* 17 */ { 6, ACTUAL_DOM_Element_Cisco_c, HDK_XML_BuiltinType_DateTime, 0 },
    /* 18 */ { 7, ACTUAL_DOM_Element_Cisco_CiscoCSVableStruct, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 19 */ { 9, ACTUAL_DOM_Element_Cisco_int, HDK_XML_BuiltinType_Int, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 20 */ { 11, ACTUAL_DOM_Element_Cisco_string, HDK_XML_BuiltinType_String, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 21 */ { 13, ACTUAL_DOM_Element_Cisco_string, ACTUAL_DOM_EnumType_Cisco_CiscoEnum, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 22 */ { 18, ACTUAL_DOM_Element_Cisco_a, HDK_XML_BuiltinType_Int, 0 },
    /* 23 */ { 18, ACTUAL_DOM_Element_Cisco_b, HDK_XML_BuiltinType_String, 0 },
    /* 24 */ { 18, ACTUAL_DOM_Element_Cisco_c, HDK_XML_BuiltinType_DateTime, 0 },
...
/*
 * Struct http://cisco.com/HNAPExt/CiscoCSVableStruct
 */

static const HDK_XML_SchemaNode s_schemaNodes_Cisco_CiscoCSVableStruct[] =
{
    /* 0 */ { 0, ACTUAL_DOM_Element_Cisco_CiscoCSVableStruct, HDK_XML_BuiltinType_Struct, 0 },
    /* 1 */ { 0, ACTUAL_DOM_Element_Cisco_a, HDK_XML_BuiltinType_Int, 0 },
    /* 2 */ { 0, ACTUAL_DOM_Element_Cisco_b, HDK_XML_BuiltinType_String, 0 },
    /* 3 */ { 0, ACTUAL_DOM_Element_Cisco_c, HDK_XML_BuiltinType_DateTime, 0 },
    HDK_XML_Schema_SchemaNodesEnd
};

static const HDK_XML_Schema s_schema_Cisco_CiscoCSVableStruct =
{
    s_namespaces,
    s_elements,
    s_schemaNodes_Cisco_CiscoCSVableStruct,
    s_enumTypes
};

/* extern */ const HDK_XML_Schema* ACTUAL_DOM_Schema_Cisco_CiscoCSVableStruct()
{
    return &s_schema_Cisco_CiscoCSVableStruct;
}
