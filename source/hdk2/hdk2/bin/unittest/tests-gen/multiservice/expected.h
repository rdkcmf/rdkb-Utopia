...
typedef enum _ACTUAL_Element
{
    ...
    ACTUAL_Element_Cisco_CiscoAction2 = 1,
    ACTUAL_Element_Cisco_CiscoAction2Response = 2,
    ACTUAL_Element_Cisco_CiscoAction2Result = 3,
    ACTUAL_Element_Cisco_CiscoActionResponse = 4,
    ACTUAL_Element_Cisco_CiscoActionResult = 5,
    ACTUAL_Element_Cisco_CiscoEvent = 6,
    ACTUAL_Element_Cisco_CiscoStruct = 7,
    ACTUAL_Element_Cisco_a = 8,
    ACTUAL_Element_Cisco_as = 9,
    ACTUAL_Element_Cisco_b = 10,
    ACTUAL_Element_Cisco_bool = 11,
    ACTUAL_Element_Cisco_bs = 12,
    ACTUAL_Element_Cisco_c = 13,
    ACTUAL_Element_Cisco_cs = 14,
    ACTUAL_Element_Cisco_extra = 15,
    ACTUAL_Element_Cisco_in = 16,
    ACTUAL_Element_Cisco_int = 17,
    ACTUAL_Element_Cisco_out = 18,
    ACTUAL_Element_Cisco_someFlag = 19,
    ACTUAL_Element_Cisco_string = 20,
    ACTUAL_Element_Cisco_stuff = 21,
    ACTUAL_Element_Cisco_x = 22,
    ACTUAL_Element_Cisco_A_CiscoAction = 23,
    ACTUAL_Element_Cisco_A_CiscoActionResponse = 24,
    ACTUAL_Element_Cisco_A_CiscoActionResult = 25,
    ACTUAL_Element_Cisco_A_CiscoStruct = 26,
    ACTUAL_Element_Cisco_A_a = 27,
    ACTUAL_Element_Cisco_A_as = 28,
    ACTUAL_Element_Cisco_A_b = 29,
    ACTUAL_Element_Cisco_A_bs = 30,
    ACTUAL_Element_Cisco_A_c = 31,
    ACTUAL_Element_Cisco_A_cs = 32,
    ACTUAL_Element_Cisco_A_int = 33,
    ACTUAL_Element_Cisco_A_string = 34,
    ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Body = 35,
    ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Envelope = 36,
    ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Header = 37
} ACTUAL_Element;
...
{
    ACTUAL_EnumType_Cisco_CiscoAction2Result = -1,
    ACTUAL_EnumType_Cisco_CiscoActionResult = -2,
    ACTUAL_EnumType_Cisco_CiscoEnum = -3,
    ACTUAL_EnumType_Cisco_A_CiscoActionResult = -4,
    ACTUAL_EnumType_Cisco_A_CiscoEnum = -5
} ACTUAL_EnumType;
...
typedef enum _ACTUAL_Enum_Cisco_CiscoAction2Result
{
    ACTUAL_Enum_Cisco_CiscoAction2Result__UNKNOWN__ = HDK_XML_Enum_Unknown,
    ACTUAL_Enum_Cisco_CiscoAction2Result_OK = 0,
    ACTUAL_Enum_Cisco_CiscoAction2Result_ERROR = 1
} ACTUAL_Enum_Cisco_CiscoAction2Result;

#define ACTUAL_Set_Cisco_CiscoAction2Result(pStruct, element, value) HDK_XML_Set_Enum(pStruct, element, ACTUAL_EnumType_Cisco_CiscoAction2Result, 0 ? ACTUAL_Enum_Cisco_CiscoAction2Result_OK : (value))
#define ACTUAL_Append_Cisco_CiscoAction2Result(pStruct, element, value) HDK_XML_Append_Enum(pStruct, element, ACTUAL_EnumType_Cisco_CiscoAction2Result, 0 ? ACTUAL_Enum_Cisco_CiscoAction2Result_OK : (value))
#define ACTUAL_Get_Cisco_CiscoAction2Result(pStruct, element) (ACTUAL_Enum_Cisco_CiscoAction2Result*)HDK_XML_Get_Enum(pStruct, element, ACTUAL_EnumType_Cisco_CiscoAction2Result)
#define ACTUAL_GetEx_Cisco_CiscoAction2Result(pStruct, element, value) (ACTUAL_Enum_Cisco_CiscoAction2Result)HDK_XML_GetEx_Enum(pStruct, element, ACTUAL_EnumType_Cisco_CiscoAction2Result, 0 ? ACTUAL_Enum_Cisco_CiscoAction2Result_OK : (value))
#define ACTUAL_GetMember_Cisco_CiscoAction2Result(pMember) (ACTUAL_Enum_Cisco_CiscoAction2Result*)HDK_XML_GetMember_Enum(pMember, ACTUAL_EnumType_Cisco_CiscoAction2Result)
...
typedef enum _ACTUAL_MethodEnum
{
    ...
    ACTUAL_MethodEnum_Cisco_CiscoAction2 = 1,
    ACTUAL_MethodEnum_Cisco_A_CiscoAction = 2
} ACTUAL_MethodEnum;
...
#define __ACTUAL_METHOD_CISCO_CISCOACTION2__
...
extern void ACTUAL_Method_Cisco_CiscoAction2(HDK_MOD_MethodContext* pMethodCtx, HDK_XML_Struct* pInput, HDK_XML_Struct* pOutput);
...
typedef enum _ACTUAL_EventEnum
{
    ACTUAL_EventEnum_Cisco_CiscoEvent = 0
} ACTUAL_EventEnum;
