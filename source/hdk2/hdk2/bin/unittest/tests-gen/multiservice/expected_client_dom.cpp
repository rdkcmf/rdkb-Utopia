...
Cisco::CiscoAction2Struct::CiscoAction2Struct() throw() :
    Struct(ACTUAL_CLIENT_DOM_MOD_Element_Cisco_CiscoAction2)
{
}

Cisco::CiscoStructArray Cisco::CiscoAction2Struct::get_in() const throw()
{
    return HDK_XML_Get_Struct(GetStruct(), ACTUAL_CLIENT_DOM_MOD_Element_Cisco_in);
}

void Cisco::CiscoAction2Struct::set_in(const Cisco::CiscoStructArray& value) throw()
{
    (void)HDK_XML_SetEx_Struct(GetStruct(), ACTUAL_CLIENT_DOM_MOD_Element_Cisco_in, value);
}

HDK_XML_Int Cisco::CiscoAction2Struct::get_x() const throw()
{
    return HDK_XML_GetEx_Int(GetStruct(), ACTUAL_CLIENT_DOM_MOD_Element_Cisco_x, 0);
}

void Cisco::CiscoAction2Struct::set_x(HDK_XML_Int value) throw()
{
    (void)HDK_XML_Set_Int(GetStruct(), ACTUAL_CLIENT_DOM_MOD_Element_Cisco_x, value);
}
...
{
    return (enum Cisco::CiscoAction2Result)ACTUAL_CLIENT_DOM_MOD_GetEx_Cisco_CiscoAction2Result(GetStruct(), ACTUAL_CLIENT_DOM_MOD_Element_Cisco_CiscoAction2Result, ACTUAL_CLIENT_DOM_MOD_Enum_Cisco_CiscoAction2Result__UNKNOWN__);
}

Cisco::CiscoStructStruct Cisco::CiscoAction2ResponseStruct::get_out() const throw()
{
    return HDK_XML_Get_Struct(GetStruct(), ACTUAL_CLIENT_DOM_MOD_Element_Cisco_out);
}

Cisco::BooleanArray Cisco::CiscoAction2ResponseStruct::get_extra() const throw()
{
    return HDK_XML_Get_Struct(GetStruct(), ACTUAL_CLIENT_DOM_MOD_Element_Cisco_extra);
}
...
) throw()
{
    ...
    ClientError error = pTarget->Request(timeoutSecs,
                                         ACTUAL_CLIENT_DOM_MOD_Module(),
                                         ACTUAL_CLIENT_DOM_MOD_MethodEnum_Cisco_CiscoAction2,
                                         input,
                                         &output);

    const HDK_MOD_Method* pMethod = HDK_MOD_GetMethod(ACTUAL_CLIENT_DOM_MOD_Module(), ACTUAL_CLIENT_DOM_MOD_MethodEnum_Cisco_CiscoAction2);
