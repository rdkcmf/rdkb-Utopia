...
typedef enum _ACTUAL_DOM_Element
{
    ...
    ACTUAL_DOM_Element_Cisco_CiscoAction2 = 1,
    ACTUAL_DOM_Element_Cisco_CiscoAction2Response = 2,
    ACTUAL_DOM_Element_Cisco_CiscoAction2Result = 3,
    ACTUAL_DOM_Element_Cisco_CiscoActionResponse = 4,
    ACTUAL_DOM_Element_Cisco_CiscoActionResult = 5,
    ACTUAL_DOM_Element_Cisco_CiscoEvent = 6,
    ACTUAL_DOM_Element_Cisco_CiscoStruct = 7,
    ACTUAL_DOM_Element_Cisco_a = 8,
    ACTUAL_DOM_Element_Cisco_as = 9,
    ACTUAL_DOM_Element_Cisco_b = 10,
    ACTUAL_DOM_Element_Cisco_bool = 11,
    ACTUAL_DOM_Element_Cisco_bs = 12,
    ACTUAL_DOM_Element_Cisco_c = 13,
    ACTUAL_DOM_Element_Cisco_cs = 14,
    ACTUAL_DOM_Element_Cisco_extra = 15,
    ACTUAL_DOM_Element_Cisco_in = 16,
    ACTUAL_DOM_Element_Cisco_int = 17,
    ACTUAL_DOM_Element_Cisco_out = 18,
    ACTUAL_DOM_Element_Cisco_someFlag = 19,
    ACTUAL_DOM_Element_Cisco_string = 20,
    ACTUAL_DOM_Element_Cisco_stuff = 21,
    ACTUAL_DOM_Element_Cisco_x = 22,
    ACTUAL_DOM_Element_Cisco_A_CiscoAction = 23,
    ACTUAL_DOM_Element_Cisco_A_CiscoActionResponse = 24,
    ACTUAL_DOM_Element_Cisco_A_CiscoActionResult = 25,
    ACTUAL_DOM_Element_Cisco_A_CiscoStruct = 26,
    ACTUAL_DOM_Element_Cisco_A_a = 27,
    ACTUAL_DOM_Element_Cisco_A_as = 28,
    ACTUAL_DOM_Element_Cisco_A_b = 29,
    ACTUAL_DOM_Element_Cisco_A_bs = 30,
    ACTUAL_DOM_Element_Cisco_A_c = 31,
    ACTUAL_DOM_Element_Cisco_A_cs = 32,
    ACTUAL_DOM_Element_Cisco_A_int = 33,
    ACTUAL_DOM_Element_Cisco_A_string = 34,
    ACTUAL_DOM_Element_Schemas_xmlsoap_org_soap_envelope_Body = 35,
    ACTUAL_DOM_Element_Schemas_xmlsoap_org_soap_envelope_Envelope = 36,
    ACTUAL_DOM_Element_Schemas_xmlsoap_org_soap_envelope_Header = 37
} ACTUAL_DOM_Element;
...
{
    ACTUAL_DOM_EnumType_Cisco_CiscoAction2Result = -1,
    ACTUAL_DOM_EnumType_Cisco_CiscoActionResult = -2,
    ACTUAL_DOM_EnumType_Cisco_CiscoEnum = -3,
    ACTUAL_DOM_EnumType_Cisco_A_CiscoActionResult = -4,
    ACTUAL_DOM_EnumType_Cisco_A_CiscoEnum = -5
} ACTUAL_DOM_EnumType;
...
typedef enum _ACTUAL_DOM_Enum_Cisco_CiscoAction2Result
{
    ACTUAL_DOM_Enum_Cisco_CiscoAction2Result__UNKNOWN__ = HDK_XML_Enum_Unknown,
    ACTUAL_DOM_Enum_Cisco_CiscoAction2Result_OK = 0,
    ACTUAL_DOM_Enum_Cisco_CiscoAction2Result_ERROR = 1
} ACTUAL_DOM_Enum_Cisco_CiscoAction2Result;

#define ACTUAL_DOM_Set_Cisco_CiscoAction2Result(pStruct, element, value) HDK_XML_Set_Enum(pStruct, element, ACTUAL_DOM_EnumType_Cisco_CiscoAction2Result, 0 ? ACTUAL_DOM_Enum_Cisco_CiscoAction2Result_OK : (value))
#define ACTUAL_DOM_Append_Cisco_CiscoAction2Result(pStruct, element, value) HDK_XML_Append_Enum(pStruct, element, ACTUAL_DOM_EnumType_Cisco_CiscoAction2Result, 0 ? ACTUAL_DOM_Enum_Cisco_CiscoAction2Result_OK : (value))
#define ACTUAL_DOM_Get_Cisco_CiscoAction2Result(pStruct, element) (ACTUAL_DOM_Enum_Cisco_CiscoAction2Result*)HDK_XML_Get_Enum(pStruct, element, ACTUAL_DOM_EnumType_Cisco_CiscoAction2Result)
#define ACTUAL_DOM_GetEx_Cisco_CiscoAction2Result(pStruct, element, value) (ACTUAL_DOM_Enum_Cisco_CiscoAction2Result)HDK_XML_GetEx_Enum(pStruct, element, ACTUAL_DOM_EnumType_Cisco_CiscoAction2Result, 0 ? ACTUAL_DOM_Enum_Cisco_CiscoAction2Result_OK : (value))
#define ACTUAL_DOM_GetMember_Cisco_CiscoAction2Result(pMember) (ACTUAL_DOM_Enum_Cisco_CiscoAction2Result*)HDK_XML_GetMember_Enum(pMember, ACTUAL_DOM_EnumType_Cisco_CiscoAction2Result)
...
typedef enum _ACTUAL_DOM_MethodEnum
{
    ...
    ACTUAL_DOM_MethodEnum_Cisco_CiscoAction2 = 1,
    ACTUAL_DOM_MethodEnum_Cisco_A_CiscoAction = 2
...
#define __ACTUAL_DOM_METHOD_CISCO_CISCOACTION2__
...
extern void ACTUAL_DOM_Method_Cisco_CiscoAction2(HDK_MOD_MethodContext* pMethodCtx, HDK_XML_Struct* pInput, HDK_XML_Struct* pOutput);
...
typedef enum _ACTUAL_DOM_EventEnum
{
    ACTUAL_DOM_EventEnum_Cisco_CiscoEvent = 0
} ACTUAL_DOM_EventEnum;
