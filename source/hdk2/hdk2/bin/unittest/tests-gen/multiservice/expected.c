...
static const HDK_XML_ElementNode s_elements[] =
{
    ...
    /* ACTUAL_Element_Cisco_CiscoAction2 = 1 */ { 0, "CiscoAction2" },
    /* ACTUAL_Element_Cisco_CiscoAction2Response = 2 */ { 0, "CiscoAction2Response" },
    /* ACTUAL_Element_Cisco_CiscoAction2Result = 3 */ { 0, "CiscoAction2Result" },
    /* ACTUAL_Element_Cisco_CiscoActionResponse = 4 */ { 0, "CiscoActionResponse" },
    /* ACTUAL_Element_Cisco_CiscoActionResult = 5 */ { 0, "CiscoActionResult" },
    /* ACTUAL_Element_Cisco_CiscoEvent = 6 */ { 0, "CiscoEvent" },
    /* ACTUAL_Element_Cisco_CiscoStruct = 7 */ { 0, "CiscoStruct" },
    /* ACTUAL_Element_Cisco_a = 8 */ { 0, "a" },
    /* ACTUAL_Element_Cisco_as = 9 */ { 0, "as" },
    /* ACTUAL_Element_Cisco_b = 10 */ { 0, "b" },
    /* ACTUAL_Element_Cisco_bool = 11 */ { 0, "bool" },
    /* ACTUAL_Element_Cisco_bs = 12 */ { 0, "bs" },
    /* ACTUAL_Element_Cisco_c = 13 */ { 0, "c" },
    /* ACTUAL_Element_Cisco_cs = 14 */ { 0, "cs" },
    /* ACTUAL_Element_Cisco_extra = 15 */ { 0, "extra" },
    /* ACTUAL_Element_Cisco_in = 16 */ { 0, "in" },
    /* ACTUAL_Element_Cisco_int = 17 */ { 0, "int" },
    /* ACTUAL_Element_Cisco_out = 18 */ { 0, "out" },
    /* ACTUAL_Element_Cisco_someFlag = 19 */ { 0, "someFlag" },
    /* ACTUAL_Element_Cisco_string = 20 */ { 0, "string" },
    /* ACTUAL_Element_Cisco_stuff = 21 */ { 0, "stuff" },
    /* ACTUAL_Element_Cisco_x = 22 */ { 0, "x" },
    /* ACTUAL_Element_Cisco_A_CiscoAction = 23 */ { 1, "CiscoAction" },
    /* ACTUAL_Element_Cisco_A_CiscoActionResponse = 24 */ { 1, "CiscoActionResponse" },
    /* ACTUAL_Element_Cisco_A_CiscoActionResult = 25 */ { 1, "CiscoActionResult" },
    /* ACTUAL_Element_Cisco_A_CiscoStruct = 26 */ { 1, "CiscoStruct" },
    /* ACTUAL_Element_Cisco_A_a = 27 */ { 1, "a" },
    /* ACTUAL_Element_Cisco_A_as = 28 */ { 1, "as" },
    /* ACTUAL_Element_Cisco_A_b = 29 */ { 1, "b" },
    /* ACTUAL_Element_Cisco_A_bs = 30 */ { 1, "bs" },
    /* ACTUAL_Element_Cisco_A_c = 31 */ { 1, "c" },
    /* ACTUAL_Element_Cisco_A_cs = 32 */ { 1, "cs" },
    /* ACTUAL_Element_Cisco_A_int = 33 */ { 1, "int" },
    /* ACTUAL_Element_Cisco_A_string = 34 */ { 1, "string" },
    /* ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Body = 35 */ { 2, "Body" },
    /* ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Envelope = 36 */ { 2, "Envelope" },
    /* ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Header = 37 */ { 2, "Header" },
...
static const HDK_XML_SchemaNode s_schemaNodes_Cisco_CiscoAction_Input[] =
{
    ...
    /* 5 */ { 4, ACTUAL_Element_Cisco_a, HDK_XML_BuiltinType_Int, 0 },
    /* 6 */ { 4, ACTUAL_Element_Cisco_as, HDK_XML_BuiltinType_Struct, 0 },
    /* 7 */ { 4, ACTUAL_Element_Cisco_b, HDK_XML_BuiltinType_String, 0 },
    /* 8 */ { 4, ACTUAL_Element_Cisco_bs, HDK_XML_BuiltinType_Struct, 0 },
    /* 9 */ { 4, ACTUAL_Element_Cisco_c, ACTUAL_EnumType_Cisco_CiscoEnum, 0 },
    /* 10 */ { 4, ACTUAL_Element_Cisco_cs, HDK_XML_BuiltinType_Struct, 0 },
    /* 11 */ { 6, ACTUAL_Element_Cisco_int, HDK_XML_BuiltinType_Int, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 12 */ { 8, ACTUAL_Element_Cisco_string, HDK_XML_BuiltinType_String, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 13 */ { 10, ACTUAL_Element_Cisco_string, ACTUAL_EnumType_Cisco_CiscoEnum, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
...
static const HDK_XML_SchemaNode s_schemaNodes_Cisco_CiscoAction2_Input[] =
{
    ...
    /* 1 */ { 0, ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Header, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_AnyElement },
    /* 2 */ { 0, ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Body, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_ErrorOutput },
    /* 3 */ { 2, ACTUAL_Element_Cisco_CiscoAction2, HDK_XML_BuiltinType_Struct, 0 },
    /* 4 */ { 3, ACTUAL_Element_Cisco_in, HDK_XML_BuiltinType_Struct, 0 },
    /* 5 */ { 3, ACTUAL_Element_Cisco_x, HDK_XML_BuiltinType_Int, 0 },
    /* 6 */ { 4, ACTUAL_Element_Cisco_CiscoStruct, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 7 */ { 6, ACTUAL_Element_Cisco_a, HDK_XML_BuiltinType_Int, 0 },
    /* 8 */ { 6, ACTUAL_Element_Cisco_as, HDK_XML_BuiltinType_Struct, 0 },
    /* 9 */ { 6, ACTUAL_Element_Cisco_b, HDK_XML_BuiltinType_String, 0 },
    /* 10 */ { 6, ACTUAL_Element_Cisco_bs, HDK_XML_BuiltinType_Struct, 0 },
...
{
    ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Body,
    ACTUAL_Element_Cisco_CiscoAction2,
    HDK_MOD_ElementPathEnd
};
...
static const HDK_XML_SchemaNode s_schemaNodes_Cisco_CiscoAction2_Output[] =
{
    ...
    /* 1 */ { 0, ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Header, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_AnyElement },
    /* 2 */ { 0, ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Body, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_ErrorOutput },
    /* 3 */ { 2, ACTUAL_Element_Cisco_CiscoAction2Response, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_ErrorOutput },
    /* 4 */ { 3, ACTUAL_Element_Cisco_CiscoAction2Result, ACTUAL_EnumType_Cisco_CiscoAction2Result, HDK_XML_SchemaNodeProperty_ErrorOutput },
    /* 5 */ { 3, ACTUAL_Element_Cisco_out, HDK_XML_BuiltinType_Struct, 0 },
    /* 6 */ { 3, ACTUAL_Element_Cisco_extra, HDK_XML_BuiltinType_Struct, 0 },
    /* 7 */ { 5, ACTUAL_Element_Cisco_a, HDK_XML_BuiltinType_Int, 0 },
    /* 8 */ { 5, ACTUAL_Element_Cisco_as, HDK_XML_BuiltinType_Struct, 0 },
    /* 9 */ { 5, ACTUAL_Element_Cisco_b, HDK_XML_BuiltinType_String, 0 },
    /* 10 */ { 5, ACTUAL_Element_Cisco_bs, HDK_XML_BuiltinType_Struct, 0 },
    /* 11 */ { 5, ACTUAL_Element_Cisco_c, ACTUAL_EnumType_Cisco_CiscoEnum, 0 },
    /* 12 */ { 5, ACTUAL_Element_Cisco_cs, HDK_XML_BuiltinType_Struct, 0 },
    /* 13 */ { 6, ACTUAL_Element_Cisco_bool, HDK_XML_BuiltinType_Bool, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 14 */ { 8, ACTUAL_Element_Cisco_int, HDK_XML_BuiltinType_Int, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 15 */ { 10, ACTUAL_Element_Cisco_string, HDK_XML_BuiltinType_String, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 16 */ { 12, ACTUAL_Element_Cisco_string, ACTUAL_EnumType_Cisco_CiscoEnum, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    HDK_XML_Schema_SchemaNodesEnd
};
...
{
    ACTUAL_Element_Schemas_xmlsoap_org_soap_envelope_Body,
    ACTUAL_Element_Cisco_CiscoAction2Response,
    HDK_MOD_ElementPathEnd
};
...
static const HDK_MOD_Method s_methods[] =
{
    ...
    },
    {
        ...
        ACTUAL_Method_Cisco_CiscoAction2,
        ...
        0,
        ACTUAL_Element_Cisco_CiscoAction2Result,
        ACTUAL_EnumType_Cisco_CiscoAction2Result,
        ACTUAL_Enum_Cisco_CiscoAction2Result_OK,
        ACTUAL_Enum_Cisco_CiscoAction2Result_OK
    },
    {
        "POST",
...
{
    /* 0 */ { 0, ACTUAL_Element_Cisco_CiscoEvent, HDK_XML_BuiltinType_Struct, 0 },
    /* 1 */ { 0, ACTUAL_Element_Cisco_stuff, HDK_XML_BuiltinType_Struct, 0 },
    /* 2 */ { 0, ACTUAL_Element_Cisco_someFlag, HDK_XML_BuiltinType_Bool, 0 },
    /* 3 */ { 1, ACTUAL_Element_Cisco_CiscoStruct, HDK_XML_BuiltinType_Struct, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 4 */ { 3, ACTUAL_Element_Cisco_a, HDK_XML_BuiltinType_Int, 0 },
    /* 5 */ { 3, ACTUAL_Element_Cisco_as, HDK_XML_BuiltinType_Struct, 0 },
    /* 6 */ { 3, ACTUAL_Element_Cisco_b, HDK_XML_BuiltinType_String, 0 },
    /* 7 */ { 3, ACTUAL_Element_Cisco_bs, HDK_XML_BuiltinType_Struct, 0 },
    /* 8 */ { 3, ACTUAL_Element_Cisco_c, ACTUAL_EnumType_Cisco_CiscoEnum, 0 },
    /* 9 */ { 3, ACTUAL_Element_Cisco_cs, HDK_XML_BuiltinType_Struct, 0 },
    /* 10 */ { 5, ACTUAL_Element_Cisco_int, HDK_XML_BuiltinType_Int, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 11 */ { 7, ACTUAL_Element_Cisco_string, HDK_XML_BuiltinType_String, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    /* 12 */ { 9, ACTUAL_Element_Cisco_string, ACTUAL_EnumType_Cisco_CiscoEnum, HDK_XML_SchemaNodeProperty_Optional | HDK_XML_SchemaNodeProperty_Unbounded },
    HDK_XML_Schema_SchemaNodesEnd
};
...
{
    &s_methods[ACTUAL_MethodEnum_Cisco_CiscoAction2],
    0
};
...
{
    &s_events[ACTUAL_EventEnum_Cisco_CiscoEvent],
    0
};
