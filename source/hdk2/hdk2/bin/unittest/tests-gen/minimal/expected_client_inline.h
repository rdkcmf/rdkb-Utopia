...
namespace HDK
{
    ...
    namespace Cisco
    {
        ...
        public:
            ...
            {
                return (enum CiscoActionResult)ACTUAL_CLIENT_MOD_GetEx_Cisco_CiscoActionResult(GetStruct(), ACTUAL_CLIENT_MOD_Element_Cisco_CiscoActionResult, ACTUAL_CLIENT_MOD_Enum_Cisco_CiscoActionResult__UNKNOWN__);
            }
