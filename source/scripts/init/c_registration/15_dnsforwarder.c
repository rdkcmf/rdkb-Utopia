...
void srv_register(void) {
   ...
   // dns forwarder (dnsmasq) is actually started as dhcp server
   // so here just set the status to started
   system("sysevent set dns-status started");
}
